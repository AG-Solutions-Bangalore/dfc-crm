...
const DashboardCard = ({ icon: Icon, label, value, color = 'blue' }) => (
  <div className={`bg-white shadow-lg rounded-2xl p-5 border-l-4 border-${color}-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2`}>
...
//sajid
  ...
  <Layout>
    ...
    <TableSection 
          ...
          columns={['Date', 'Company', 'Branch', 'Supplier','Bill Ref','Amount','No of Tyres']}
          data={dashboardData.purchaseTyre}
          renderRow={(item, index) => (
            <tr key={index} className="hover:bg-gray-50">
              <td className="px-4 py-3">{moment(item.tyre_date).format('DD-MM-YYYY')}</td>
              ...
              <td className="px-4 py-3">{item.tyre_bill_ref
              }</td>
        ...
        <TableSection 
          ...
          renderRow={(item, index) => (
            <tr key={index} className="hover:bg-gray-50">
              ...
              <td className="px-4 py-3">{moment(item.ins_due).format('DD-MM-YYYY')}</td>
            </tr>
          )}
        />
        ...
        <TableSection 
          ...
          renderRow={(item, index) => (
            <tr key={index} className="hover:bg-gray-50">
              ...
              <td className="px-4 py-3">{moment(item.fc_due).format('DD-MM-YYYY')}</td>
            </tr>
          )}
        />
      </div>
        ...
        <TableSection 
          ...
          renderRow={(item, index) => (
            <tr key={index} className="hover:bg-gray-50">
              ...
              <td className="px-4 py-3">{moment(item.trip_date).format('DD-MM-YYYY')}</td>
