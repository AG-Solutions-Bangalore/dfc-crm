...
import { Button, Paper, TextInput, Group, Box, Select } from "@mantine/core";
                                    ...
                                    {tyrePositions.map((position, posIndex) => {
                                      ...
                                      if (numericKmRun != null) {
                                        if (statusLower == "new") {
                                          ...
                                          statusLower === "1st retread" ||
                                          statusLower === "1stretread"
                                        ) {
                                          if (
                                            numericKmRun >= 25000 &&
                                            numericKmRun <= 35000
