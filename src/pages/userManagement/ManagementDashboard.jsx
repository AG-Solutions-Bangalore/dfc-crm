  ...
  if (isErrorPages || isErrorButtons) {
    return (
      <Layout>
        <div className="container mx-auto p-6">
          <div className="flex items-center justify-center h-64">
            <div className="text-lg text-red-600">Error loading user management</div>
          </div>
        </div>
      </Layout>
    );
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            {pages.map((page) => {
              ...
              const pagePermissionsForPage = pagePermissions.filter((p) => p.page === page);
                ...
                <div key={page} className="mb-8">
                  {pagePermissionsForPage.map((permission) => (
                    <div key={permission.id} className="mb-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="text-xl font-semibold">{permission.page}</h3>
                          {/* Display the URL here */}
                          <p className="text-sm text-gray-600">URL: {permission.url}</p>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handlePagePermissionChange(permission.page, e.target.checked)
                            }
                            className="h-5 w-5"
                          />
                        </div>
