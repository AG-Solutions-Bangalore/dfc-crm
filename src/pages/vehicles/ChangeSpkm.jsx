                  ...
                  <div className="overflow-x-auto mb-6">
                    <table className="w-full border-collapse">
                      ...
                      <tr className="bg-orange-300">
                          <td className="border p-2 text-center" >{tyre.service_sub_type}</td>
                          <td className="border p-2 text-center" >{tyre.service_sub_date}</td>
                          <td className="border p-2 text-center" >{tyre.service_sub_km}</td>
                          <td className="border p-2 text-center" >{tyre.service_sub_pre_km}</td>
                          <td className="border p-2 text-center" >{tyre.service_sub_pre_km - tyre.service_sub_km}</td>
