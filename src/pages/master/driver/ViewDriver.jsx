          ...
          <CardBody className="max-h-[24rem] overflow-y-auto">
            <div className="space-y-4">
              ...
              <div>
                ...
                <DetailRow label="DL Expire" value={driver?.dl_expiry} />
                <DetailRow label="Hazard Lice No" value={driver?.hazard_lice_no} />
                <DetailRow label="H L No Expire" value={driver?.hazard_lice_expiry} />
              ...
              <div>
                ...
                <DetailRow label="Photo"  downloadUrl={`https://dfclogistics.online/storage/app/public/profiles/${driver?.user_image}`} />
                <DetailRow label="Aadhar Card"  downloadUrl={`https://dfclogistics.online/storage/app/public/profiles_document/${driver?.user_adhar_card}`} />
                <DetailRow label="Pan Card"  downloadUrl={`https://dfclogistics.online/storage/app/public/profiles_document/${driver?.user_pan_card}`} />
                <DetailRow label="Passbook"  downloadUrl={`https://dfclogistics.online/storage/app/public/profiles_document/${driver?.user_passbook}`} />
                <DetailRow label="Licence"  downloadUrl={`https://dfclogistics.online/storage/app/public/profiles_document/${driver?.user_licence}`} />
