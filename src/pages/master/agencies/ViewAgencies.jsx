      ...
      <CardBody className="max-h-[24rem] overflow-y-auto">
        <div className="space-y-4">
          ...
          <div>
            ...
            <DetailRow label="Place" value={agency?.agency_state} />
            <DetailRow label="Contact Person" value={agency?.agency_contact_person} />
            <DetailRow label="Mobile" value={agency?.agency_mobile} />
            <DetailRow label="Email" value={agency?.agency_email} />
            <DetailRow label="Bata for Trip 6W" value={agency?.agency_bata_for_trip_6W} />
            <DetailRow label="Bata for Trip 10W" value={agency?.agency_bata_for_trip_10W} />
            <DetailRow label="Hamali for 6W" value={agency?.agency_hmali} />
            <DetailRow label="Hamali for 10W" value={agency?.agency_hmali_10W} />
