             ...
             >
               <div className="grid grid-cols-1  md:grid-cols-1 lg:grid-cols-4   gap-6">
                 ...
                 <div>
                   ...
                   />
                   <span className='text-[11px] p-1 ml-2 text-red-900'>{team?.user_image}</span>
                 </div>
                 {/* Aadhar Card */}
                 <div>
                   ...
                   <input
                     ...
                     required
                       className="w-full px-3 py-1 text-xs border rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 border-blue-500 file:mr-4 file:py-1 file:px-2 file:rounded-lg file:border-0 file:text-xs  file:bg-[#E1F5FA] file:text-black  cursor-not-allowed  "
                   />
                   <span className='text-[11px] p-1 ml-2 text-red-900'>{team?.user_adhar_card}</span>
                 </div>
                   {/* PAN Card */}
                   <div>
                   ...
                   <input
                     ...
                     required
                       className="w-full px-3 py-1 text-xs border rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 border-blue-500 file:mr-4 file:py-1 file:px-2 file:rounded-lg file:border-0 file:text-xs  file:bg-[#E1F5FA] file:text-black  cursor-not-allowed  "
                   />
                      <span className='text-[11px] p-1 ml-2 text-red-900'>{team?.user_pan_card}</span>
                 </div>
                 {/* Pass Book */}
                 <div>
                   ...
                   <input
                     ...
                     required
                       className="w-full px-3 py-1 text-xs border rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 border-blue-500 file:mr-4 file:py-1 file:px-2 file:rounded-lg file:border-0 file:text-xs  file:bg-[#E1F5FA] file:text-black  cursor-not-allowed  "
                   />
                    <span className='text-[11px] p-1 ml-2 text-red-900'>{team?.user_passbook}</span>
                 </div>
                 {/* Licence */}
                 <div>
                   ...
                   <input
                     ...
                     required
                       className="w-full px-3 py-1 text-xs border rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 border-blue-500 file:mr-4 file:py-1 file:px-2 file:rounded-lg file:border-0 file:text-xs  file:bg-[#E1F5FA] file:text-black  cursor-not-allowed  "
                   />
                       <span className='text-[11px] p-1 ml-2 text-red-900'>{team?.user_licence}</span>
                 </div>
